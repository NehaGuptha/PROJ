...
import 'package:flutter_range_slider/flutter_range_slider.dart' as fos;
...
class item extends State<Item_Screen> {
  ...
  List<Item> itemList = <Item>[
    Item(imagename: 'apple.jpg', itemname: 'Apple', itmprice: '\$10'),
    Item(imagename: 'tomato.jpg', itemname: 'Tomato', itmprice: '\$15'),
    Item(imagename: 'lemons.jpg', itemname: 'Lemon', itmprice: '\$25'),
    Item(
        imagename: 'kiwi.jpg', itemname: 'Kiwi Fruit', itmprice: '\$10'),
    Item(imagename: 'guava.jpg', itemname: 'Guava', itmprice: '\$15'),
    Item(imagename: 'grapes.jpg', itemname: 'Grapes', itmprice: '\$25'),
    Item(
...
class RangeSliderData {
  ...
  // based on parameters
  //
  Widget build(BuildContext context, fos.RangeSliderCallback callback) {
